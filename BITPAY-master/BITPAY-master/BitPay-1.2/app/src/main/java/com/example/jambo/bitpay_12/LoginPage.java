...
public class LoginPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginIdentfy = (TextView)findViewById(R.id.loginIdentfy);
        imageView = (ImageView)findViewById(R.id.imageView);
        //建立按鈕的OnClickListener
        btnLogin = (Button) findViewById(R.id.btnLogin);
        if(count == 0 )loginIdentfy.setText("You will be logged in as a seller !");
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                count++;
                if(count%2==1){
                    loginIdentfy.setText("You will be logged in as a customer !");
                }
                else  loginIdentfy.setText("You will be logged in as a seller !");
    ...
    class Login extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                HttpPost post = new HttpPost("http://mcdf.asuscomm.com/test/login.php");
                //建立POST的變數
                ...
                if (response.equals(success)) {
                    ...
                    if(count%2 ==1) {
                        ...
                        Intent i = new Intent(LoginPage.this, Transaction.class);
    ...
    protected void onResume() {
        super.onResume();
        count = 0;
        loginIdentfy.setText("You will be logged in as a seller !");
    }
