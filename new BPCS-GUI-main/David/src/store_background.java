...
public class store_background {
	...
	public void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 535, 357);
		...
		labelStore_btc.setBounds(282, 26, 234, 20);
		...
		btnUpdat.setBounds(292, 233, 87, 23);
		...
		label_gettablename.setBounds(392, 117, 80, 28);
		frame.getContentPane().add(label_gettablename);

		JLabel label_gettabledetail = new JLabel("");
		label_gettabledetail.setBounds(392, 151, 80, 28);
		...
		btninsert.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				ms.Insertdata(lblStoreNovar, ms.search_product_number(pname, pdetail), textQuantity.getText(),
						showdate());
				// ms.Insertdata(100, 1, 10);
			}
		});
		btninsert.setBounds(420, 233, 87, 23);
		frame.getContentPane().add(btninsert);

		textQuantity = new JTextField();
		textQuantity.setColumns(10);
		textQuantity.setBounds(392, 179, 115, 21);
	...
	public void gettabledata() {
		...
		mysql_connect.Update_TableAll(model, 0);//lblStoreNovar
	}
